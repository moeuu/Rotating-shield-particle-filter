...
--obstacle-config PATH     # fixed-mode obstacle JSON, default obstacle_layouts/Ex5_obstacles.json
--environment-mode random  # default: generate a fresh obstacle map for this run
